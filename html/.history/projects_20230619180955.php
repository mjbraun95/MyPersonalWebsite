...
<div class="content1a">
    <div class="rightBox">
        ...
        <p style="margin: 0 auto; float: left">
            This project was made in a group of 4 for our Computer Engineering Capstone Project. In this project, we designed a three-wheeled robot in a group of 4 to autonomously plant seeds in a field It uses a LiDAR camera to detect objects, GPS + motors to navigate to the planting locations, and a servo motor to dispense different seed types. The navigation system was programmed in Python and largely used the adafruit_gps library to interface with the GPS module. The Serial Python library was used to connect the GPS module directly using the TX and RX pins. The system stores the latitudinal and longitudinal coordinates of all the locations entered through the GUI and removes each location point from the path as it reaches it to plant the seeds.
